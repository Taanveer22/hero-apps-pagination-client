  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center h-screen text-center p-5">
        ...
        <h1 className="text-6xl font-extrabold text-primary mt-5">{error.status || 404}</h1>
        <h2 className="text-2xl font-semibold mt-3">
          {error.statusText || error.message || 'Something went wrong!'}
        </h2>
        <p className="opacity-70 mt-2 max-w-md">
          Sorry, the page you are looking for might be removed, renamed, or is temporarily
          unavailable.
        </p>
