      ...
      <div className="flex flex-col  justify-center items-center md:w-11/12 mx-auto pt-10  pb-0">
        <div className="space-y-5  text-center">
          ...
          <p className="italic md:max-w-9/12 mx-auto">
            At <span className="text-primary font-bold">HERO.IO</span> , we craft innovative apps
            designed to make everyday life simpler, smarter, and more exciting. Our goal is to turn
